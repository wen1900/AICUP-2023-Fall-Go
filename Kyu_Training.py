...
from tensorflow.keras.layers import Input, Conv2D, ReLU, Flatten, Dense, Softmax, BatchNormalization, MaxPooling2D, Add
...
checkpoint_path = "./checkpoints/model_kyu_tutorial-{epoch:02d}.ckpt"
...
model = go_res()
#load weights
#model.load_weights('./weight/model_kyu_tutorial.h5')
model.summary()
...
model.save('./weight/model_kyu_tutorial.h5')